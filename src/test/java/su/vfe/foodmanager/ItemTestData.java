...
public class ItemTestData {
    ...
    public static final Item ITEM1 = new Item(ITEM1_ID, "Молоко", 1.5, "Чебаркуль", 84, false, DATE_TIME_1, null);
    public static final Item ITEM2 = new Item(ITEM1_ID + 1, "Хлеб", 1.0, "Бородинский", 30, false, DATE_TIME_1, null);
    public static final Item ITEM3 = new Item(ITEM1_ID + 2, "Кефир", 1.0, "Чебаркуль", 89, false, DATE_TIME_1, null);
    public static final Item ITEM4 = new Item(ITEM1_ID + 3, "Творог", 0.5, "Чебаркуль", 125, false, DATE_TIME_1, null);
    public static final Item ITEM5 = new Item(ITEM1_ID + 4, "Сыр", 0.3, "Артур", 200, true, DATE_TIME_2, null);
    public static final Item ITEM6 = new Item(ITEM1_ID + 5, "Яблоки", 1.5, "Сезонные", 80, true, DATE_TIME_3, null);
    public static final Item ITEM7 = new Item(ITEM1_ID + 6, "Бананы", 1.5, "", 60, false, DATE_TIME_4, null);

    public static final List<Item> ITEMS = Arrays.asList(ITEM1, ITEM2, ITEM3, ITEM4, ITEM5, ITEM6, ITEM7);

    public static Item getCreated() {
        return new Item(null, "Что-то забыла", 1.5, "", 60, false, DATE_TIME_4.plusYears(1L), null);
    }

    public static Item getUpdated() {
        return new Item(ITEM1_ID, "Молоко", 1.5, "Первый вкус", 89, false, DATE_TIME_1, null);
    }
}
